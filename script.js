...
[
    ...
    },
    {
        ...
        voices:
        [
            { text: "あひるんるん", file: "アヒル.mp3" },
            { text: "ひつじろーる", file: "ひつじ.mp3" },
            { text: "とんがりやぎこーん", file: "ヤギ.mp3" },
            { text: "おれんじきつねのきらきらきらーん", file: "キツネ.mp3" },
            { text: "ぺんぺん・ど", file: "ペンギン.mp3" },
            { text: "セイウチっち", file: "セイウチ.mp3" },
            { text: "ほわいとくまたろう", file: "シロクマ.mp3" },
            { text: "職トナカイ", file: "トナカイ.mp3" },
            { text: "ぴーちゃん", file: "オウム.mp3" },
            { text: "みんちゃん", file: "フラミンゴ.mp3" },
            { text: "フータロー", file: "フクロウ.mp3" },
            { text: "わっしっし", file: "ワシ.mp3" },
            { text: "キング", file: "ライオン.mp3" },
            { text: "さいさい", file: "サイ.mp3" },
            { text: "ぱおぞう", file: "ゾウ.mp3" },
            { text: "かばたろう", file: "カバ.mp3" },
            { text: "くままる", file: "クマ.mp3" },
            { text: "とらちゃん", file: "トラ.mp3" },
            { text: "どんきー", file: "ゴリラ.mp3" },
            { text: "ぱんぞう", file: "パンダ.mp3" },
            { text: "もんちゃん", file: "ナマケモノ.mp3" },
            { text: "ぴょこたろう", file: "カエル.mp3" },
            { text: "ちょこ", file: "イヌ.mp3" },
            { text: "くろ", file: "ネコ.mp3" },
            { text: "うさたん", file: "うさぎ.mp3" },
            { text: "めろんちゃん", file: "カメ.mp3" },
            { text: "オレノダイヤモンド", file: "ウマ.mp3" },
            { text: "もーもーたろう", file: "ウシ.mp3" },
            { text: "ぷくたろう", file: "ハムスター.mp3" },
            { text: "でんでん", file: "カタツムリ.mp3" },
        ]
    },
    {
